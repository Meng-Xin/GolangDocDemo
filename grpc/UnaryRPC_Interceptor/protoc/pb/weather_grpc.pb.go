...
const (
	WeatherService_GetTodayData_FullMethodName = "/pb.WeatherService/GetTodayData"
)
...
type WeatherServiceClient interface {
	...
	GetTodayData(ctx context.Context, in *WeatherReq, opts ...grpc.CallOption) (*WeatherResp, error)
}
...
func (c *weatherServiceClient) GetTodayData(ctx context.Context, in *WeatherReq, opts ...grpc.CallOption) (*WeatherResp, error) {
	out := new(WeatherResp)
	err := c.cc.Invoke(ctx, WeatherService_GetTodayData_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	// GetTodayData 获取今日天气数据
	GetTodayData(context.Context, *WeatherReq) (*WeatherResp, error)
...
func (UnimplementedWeatherServiceServer) GetTodayData(context.Context, *WeatherReq) (*WeatherResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTodayData not implemented")
}
...
func _WeatherService_GetTodayData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WeatherReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).GetTodayData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_GetTodayData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).GetTodayData(ctx, req.(*WeatherReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _WeatherService_GetTodayData_Handler,
		},
	},
